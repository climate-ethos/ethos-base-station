...
export const useDataSensorStore = defineStore('dataSensor', {
  ...
  actions: {
    setDemoData() {
      ...
      this.allSensorData[0].lastSeen = new Date(now.getTime() - 34 * 1000);
      ...
      this.allSensorData[1].lastSeen = new Date(now.getTime() - 600 * 1000);
      ...
      this.allSensorData[2].lastSeen = new Date(now.getTime() - 185 * 1000);
